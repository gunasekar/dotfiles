...
# <swiftbar.title>Toolbox</swiftbar.title>
...
# <swiftbar.desc>Handy menu bar app to serve as swiss-army knife for devs.</swiftbar.desc>
# <swiftbar.dependencies>shell,jq,sed,uuidgen,openssl,base64,zbarimg,date,curl</swiftbar.dependencies>
...
createHeader " | sfimage=wrench.and.screwdriver.fill" 'Toolbox'
